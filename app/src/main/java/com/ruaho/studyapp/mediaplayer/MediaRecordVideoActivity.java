...
public class MediaRecordVideoActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_media_record_video);
        ...
        try {
            ...
            mediaRecorder.setOnErrorListener(new MediaRecorder.OnErrorListener() {
                ...
                public void onError(MediaRecorder mr, int what, int extra) {
                    ...
                    btn_VideoStop.setEnabled(false);
                    Toast.makeText(MediaRecordVideoActivity.this, "录制出错", 0).show();
                }
            });
            ...
            isRecording = true;
            Toast.makeText(MediaRecordVideoActivity.this, "开始录像", 0).show();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    protected void stop() {
        if (isRecording) {
            ...
            btn_VideoStart.setEnabled(true);
            btn_VideoStop.setEnabled(false);
            Toast.makeText(MediaRecordVideoActivity.this, "停止录像，并保存文件", 0).show();
        }
    }
