package com.ruaho.studyapp.widget;
...
/**
 * Created by ruaho on 2017/11/6.
 * EditText输入银行卡号每四位空一格
 * 使用方法:
 *  链接:http://blog.csdn.net/cc_want/article/details/75070926
 *  1:xml文件里面正常使用EditText
 *  2:绑定代码:BankCardTextWatcher.bind(EditText);
 */
